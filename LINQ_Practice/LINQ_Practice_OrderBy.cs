...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(cohortsByName => cohortsByName.Name).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(StudentsByBirthday => StudentsByBirthday.Birthday)/*FILL IN LINQ EXPRESSION*/.ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(YoungestFirst => YoungestFirst.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(ByLastName => ByLastName.LastName).ToList();
