...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(YoungStudent => YoungStudent.Birthday); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var minValue = PracticeData[2].Students.Min(OldestStudent => OldestStudent.Birthday); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var maxValue = PracticeData.Max(HowMany => HowMany.JuniorInstructors.Count)/*FILL IN LINQ EXPRESSION*/; 
