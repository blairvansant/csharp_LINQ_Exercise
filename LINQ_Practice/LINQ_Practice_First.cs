...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(KateIsInstructor => KateIsInstructor.PrimaryInstructor.FirstName == "Kate");
        ...
        {
            var ActualCohort = PracticeData.First(CohortWith3Instructors => CohortWith3Instructors.JuniorInstructors.Count() == 3 );
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(InstructorNamedZelda => InstructorNamedZelda.PrimaryInstructor.FirstName == "Zelda" || InstructorNamedZelda.JuniorInstructors.Any(TestForJuniorInstructorNamedZelda => TestForJuniorInstructorNamedZelda.FirstName == "Zelda"));
        ...
        {
            var shouldThrowException = PracticeData.First(BothNotActiveAndNotFullTime => BothNotActiveAndNotFullTime.Active == false && BothNotActiveAndNotFullTime.FullTime == false);
        ...
        {
            var ActualCohort = PracticeData.First(CohortWith2JrInstructors => CohortWith2JrInstructors.JuniorInstructors.Count() == 2);
