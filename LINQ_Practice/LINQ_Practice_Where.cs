...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(ActiveCohorts => ActiveCohorts.Active == true).ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(FullTimeCohorts => FullTimeCohorts.FullTime == true).ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(InstructorIsJurnell => InstructorIsJurnell.PrimaryInstructor.FirstName == "Jurnell").ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(threeJrInstructors => threeJrInstructors.JuniorInstructors.Count == 3).ToList();
